...
function getConversationId(key, phone_number){
	...
	request.open('GET', 'https://private-a1d8aa-textline.apiary-proxy.com/api/conversations.json?phone_number='+phone_number+'&access_token='+key); /* a941205863 */
...
function addComment(comment){
	...
	var request = new XMLHttpRequest();
	request.open('POST', 'https://private-a1d8aa-textline.apiary-proxy.com/api/conversation/' + uuid + '.json?access_token=' + key);
